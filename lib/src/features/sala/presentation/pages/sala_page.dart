...
import 'package:smartmushroom_app/src/features/editar_parametros/presentation/pages/editar_parametros_page.dart';
import 'package:smartmushroom_app/src/features/sala/presentation/viewmodels/chart_aggregation.dart';
import 'package:smartmushroom_app/src/features/sala/presentation/viewmodels/sala_view_model.dart';
import 'package:smartmushroom_app/src/features/sala/presentation/widgets/co2_linechart.dart';
import 'package:smartmushroom_app/src/features/sala/presentation/widgets/humidity_linechart.dart';
import 'package:smartmushroom_app/src/features/sala/presentation/widgets/ring_chart.dart';
import 'package:smartmushroom_app/src/features/sala/presentation/widgets/temperature_linechart.dart';
...
class SalaPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ChangeNotifierProvider(
      create:
          (_) => SalaViewModel(
            repository: AppDependencies.instance.salaRepository,
            idLote: idLote,
            nomeSala: nomeSala,
          )..initialize(),
...
class _SalaView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Consumer<SalaViewModel>(
      builder: (context, viewModel, _) {
        final nomeSala = viewModel.lote?.nomeSala ?? fallbackNomeSala;
            ...
            child: Padding(
              ...
              child: Column(
                children: [
                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            ...
                            _buildInfoItem(
                              'Sala',
                              lote?.nomeSala ?? fallbackNomeSala,
                            ),
                          ],
                        ),
                      ),
                  ...
                  SizedBox(height: 24),
                  _buildAggregationToggle(
                    context,
                    viewModel.aggregation,
                    viewModel.changeAggregation,
                  ),
                  SizedBox(height: 16),
                  _buildChartSection(
                    context,
                    ...
                    TemperatureLinechart(
                      aggregation: viewModel.aggregation,
                      data: viewModel.chartFor('temperatura'),
                      isLoading: viewModel.chartsLoading,
                      errorMessage: viewModel.chartsError,
                    ),
                  ),
                  SizedBox(height: 20),
                  _buildChartSection(
                    ...
                    HumidityLinechart(
                      aggregation: viewModel.aggregation,
                      data: viewModel.chartFor('umidade'),
                      isLoading: viewModel.chartsLoading,
                      errorMessage: viewModel.chartsError,
                    ),
                  ),
  ...
  Widget _buildAggregationToggle(
    BuildContext context,
    ChartAggregation selected,
    ValueChanged<ChartAggregation> onChanged,
  ) {
